...
export class VariableSubtractionRedefinitionNode {
  ...
  static build(reader: LexReader, base: ValueTreeNode): VariableSubtractionRedefinitionNode {
    ...
    return new VariableSubtractionRedefinitionNode(new TokenRange(base.getTokenRange().getStart(), value.getTokenRange().getEnd()), base, value);
  }
}
