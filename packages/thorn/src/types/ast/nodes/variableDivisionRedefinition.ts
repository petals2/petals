...
export class VariableDivisionRedefinitionNode {
  ...
  static build(reader: LexReader, base: ValueTreeNode): VariableDivisionRedefinitionNode {
    ...
    return new VariableDivisionRedefinitionNode(new TokenRange(base.getTokenRange().getStart(), value.getTokenRange().getEnd()), base, value);
  }
}
